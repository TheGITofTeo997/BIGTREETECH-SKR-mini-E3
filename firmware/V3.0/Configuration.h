...
#define CUSTOM_MACHINE_NAME "Ender-3 SKR (CR)"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  44.40
    #define DEFAULT_Ki  6.10
    #define DEFAULT_Kd  80.7
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 96.4
  #define DEFAULT_bedKi 17.99
  #define DEFAULT_bedKd 344.3
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 386.9 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -47, -2, -0.30 }
